        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              Partner with <span className="bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">I/O School</span>
            </h1>
            
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Join forces with us to create innovative educational solutions, expand market reach, 
              and build a stronger tech ecosystem together. Let's grow and succeed as partners.
            </p>
          </div>
