          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-emerald-100 to-blue-100 p-8 rounded-3xl border border-emerald-200 max-w-2xl mx-auto">
              ...
              <p className="text-slate-700 leading-relaxed">
                Expanding to reach 10 lakh students across India, building partnerships with colleges and organizations, and creating India’s most trusted student career ecosystem.
              </p>
            </div>
          </div>
        </div>
