...
const ecosystemItems = [
  ...
  { icon: Rocket, name: "BoldtStartup", function: "Startup incubation & support", color: "from-red-500 to-pink-500" },
...
const teamMembers = [
  ...
  },
  {
    ...
    description: "Startup ecosystems, placement networks, college relations",
...
const milestones = [
  ...
  { 
    year: "2023", 
    quarter: "Q3",
    event: "Piloted with 100 students from Tier 2/3 colleges", 
    icon: Users,
    description: "Launched beta program with select colleges to validate our approach",
  ...
  { 
    year: "2025", 
    quarter: "Q1",
    event: "Scaling across India via college partnerships", 
    icon: Globe,
    description: "Expanding reach through strategic college collaborations nationwide",
    metrics: "50+ college partners"
  }
];
          ...
          <div className="text-center">
            ...
            <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl border border-slate-200 shadow-xl max-w-4xl mx-auto">
              ...
              <p className="text-base text-slate-700 leading-relaxed">
                We build confidence, proof of work, and a pathway to success — for every student, regardless of background or college tier.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="text-left md:text-center">
            ...
            <div className="bg-white/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl border border-emerald-200 shadow-2xl max-w-4xl md:mx-auto">
              ...
              <p className="text-xl text-slate-800 mb-6 font-medium">
                To enable 10 million Indian students to become career-ready by 2030.
              </p>
              <p className="text-base text-slate-700 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="md:text-center mb-16">
            ...
            <p className="text-xl text-slate-700">
              We're a team of engineers, educators, designers, mentors, and career builders.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="group relative">
                <div className="bg-gradient-to-br from-white via-slate-50 to-blue-50 p-8 rounded-3xl border border-slate-200 hover:border-blue-300 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 relative overflow-hidden">
                  {/* Background Pattern */}
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start space-x-6 mb-6">
                      <div className="relative">
                        <div className="w-20 h-20 rounded-2xl overflow-hidden shadow-xl ring-4 ring-white group-hover:ring-blue-200 transition-all duration-300">
                          <img 
                            src={member.image} 
                            alt={member.name}
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 text-xs text-slate-500">
                          <span className="bg-slate-100 px-2 py-1 rounded-full">{member.experience}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {member.expertise.map((skill, skillIndex) => (
                          <span key={skillIndex} className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium border border-blue-200">
                            {skill}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-200">
                      <div className="flex space-x-3">
                        <a href={member.linkedin} className="w-8 h-8 bg-blue-100 hover:bg-blue-200 rounded-lg flex items-center justify-center transition-colors duration-300 group/link">
                          <Linkedin className="h-4 w-4 text-blue-600 group-hover/link:scale-110 transition-transform duration-300" />
                        </a>
                        <a href={`mailto:${member.email}`} className="w-8 h-8 bg-slate-100 hover:bg-slate-200 rounded-lg flex items-center justify-center transition-colors duration-300 group/link">
                          <Mail className="h-4 w-4 text-slate-600 group-hover/link:scale-110 transition-transform duration-300" />
                        </a>
                      </div>
