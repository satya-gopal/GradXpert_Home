...
export default function CourseDetails() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-cyan-600 text-white overflow-hidden">
        {/* Background Effects */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-r from-cyan-400/20 to-blue-400/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-2 rounded-full">
                ...
                <span className="text-sm font-medium">Live Course</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 sm:gap-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="font-bold">{courseData.stats.rating}</div>
                    <div className="text-sm text-white/70">({courseData.stats.reviews.toLocaleString()} reviews)</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="font-bold">{courseData.stats.students.toLocaleString()}+</div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="font-bold">{courseData.stats.duration}</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="group flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-xl font-semibold hover:bg-white/20 transition-all duration-300">
              ...
              {/* Next Batch Info */}
              <div className="inline-flex items-center space-x-2 bg-emerald-500/20 backdrop-blur-sm border border-emerald-400/30 px-4 py-2 rounded-lg">
                <Calendar className="h-4 w-4 text-emerald-300" />
                <span className="text-sm">Next batch starts: {courseData.pricing.nextBatch}</span>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-xl font-bold shadow-lg animate-bounce">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className={`bg-white rounded-xl border border-gray-200 transition-all duration-300 ${
              isSticky ? 'sticky top-4 z-40 shadow-lg' : 'shadow-sm'
            }`}>
