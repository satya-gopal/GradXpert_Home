...
const FAQ = () => {
  ...
  return (
    <section className="py-20 md:py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="md:text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6 tracking-tight flex md:items-center md:justify-center md:justify-center space-x-4 text-left md:text-center">
