        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <div className="relative mb-10">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4 md:mb-6 leading-tight tracking-tight">
                Career{' '}
            ...
            <p className="text-base md:text-lg text-blue-700 mb-4 md:mb-5 font-semibold tracking-wide">
