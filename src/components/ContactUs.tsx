    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {socialPlatforms.map((platform, index) => {
              ...
              return (
                <a 
                  ...
                  className="bg-white/90 backdrop-blur-xl p-6 rounded-2xl border border-slate-200 hover:border-purple-300 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 group text-center"
                >
                  <div className={`w-12 h-12 bg-gradient-to-r ${platform.color} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
                    <Icon className="h-6 w-6 text-white" />
                  </div>
          ...
          {/* Newsletter Signup */}
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-8 rounded-2xl border border-purple-200 text-center">
            <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center justify-center space-x-2">
